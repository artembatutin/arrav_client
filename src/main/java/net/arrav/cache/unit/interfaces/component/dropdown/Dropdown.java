...
public enum Dropdown {
	DEFAULT() {
		@Override
		public void selectOption(int option, Client client, Interface rsint) {
			//Client.instance.outBuffer.putOpcode(255);
			//Client.instance.outBuffer.putInt(rsint.id);
			//Client.instance.outBuffer.putByte(option);
			client.sendString(rsint.textAlt, option);
		}
	};
/*	KEYBINDING() {
		@Override
	...
	public abstract void selectOption(int option, Client client, Interface rsint);
}
