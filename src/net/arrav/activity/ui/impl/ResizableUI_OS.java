...
public class ResizableUI_OS extends ResizableUI {
	...
	public void updateChat() {
		...
		if(client.messagePromptRaised) {
			...
			client.plainFont.drawLeftAlignedString(client.chatInput + "*", 13 + client.plainFont.getStringWidth(myName + ": ")+ typingCrownOffset, yoff + 134, 0);
			client.plainFont.drawLeftAlignedString(client.chatInput + "*", 12 + client.plainFont.getStringWidth(myName + ": ")+ typingCrownOffset, yoff + 133, 0x7fa9ff);
			for(int i = 0; i < 505; i++) {
	...
	public void updateMap() {
		...
		if(client.minimapOverlay == 2) {
			...
			Client.spriteCache.get(1700).drawAffineTransformedImage(xOffset + 4, 5, 33, 33, 25, 25, client.compassClipStarts, client.compassLineLengths, client.cameraAngleX, 256);
			if(Config.def.orbs()) {
